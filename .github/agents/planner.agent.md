---
description: "Produce an implementation plan for neural-network-toolbox — per-file steps, interface design, test strategy, CMake, docs. No code. Best for new algorithms or multi-file work."
...
2. **Plan** — every plan must include:
   ...
   - **CMake**: `neural_network_add_header_library()`, `neural_network_add_coverage_sources()`;
