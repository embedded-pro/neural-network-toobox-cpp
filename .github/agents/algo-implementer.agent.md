---
description: "Deploy ONE roadmap/ algorithm spec into neural_network/ as float-only production code + test + doc + CMake. Terse, minimal tests, no comments. Use for roadmap deployment."
